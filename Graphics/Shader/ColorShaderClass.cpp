...
bool ColorShaderClass::Initialize(ID3D11Device* device, HWND hwnd)
{
	...
	result = InitializeShader(device, hwnd, "D:\\Projects\\DirectX11_Tutorial\\Shaders\\04\\vcolor.hlsl", "D:\\Projects\\DirectX11_Tutorial\\Shaders\\04\\pcolor.hlsl");
	if (!result)
		return false;
...
bool ColorShaderClass::SetShaderParameters(ID3D11DeviceContext* deviceContext, D3DXMATRIX world, D3DXMATRIX view, D3DXMATRIX proj)
{
	HRESULT result;
